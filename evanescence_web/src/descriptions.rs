...
pub(crate) const DESC: Descriptions = Descriptions {
    ...
    rad_nodes: "Draw radial nodes in green, if they exist. These are concentric, spherical surfaces where there is exactly 0 possibility of finding an electron. There are n−ℓ−1 radial nodes.",
    ang_nodes: "Draw angular nodes in purple, if they exist. These are planar or conical surfaces where there is exactly 0 possibility of finding an electron. There are ℓ angular nodes.",
    ...
    qn_m: "m corresponds to how angular momentum is aligned.",
