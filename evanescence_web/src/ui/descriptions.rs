...
descriptions! {
    ...
    rad_prob_distr: "The probability of finding the electron within a shell of inner radius <i>a</i> and outer radius <i>b</i> is given by the area under the portion of this curve running from <i>a</i> to <i>b</i>. By definition, the total area under this curve from 0 to infinity, corresponding to the probability of finding the electron anywhere in space, is 1. The measured distribution of the point cloud samples is also drawn; click on the legend entries to toggle the graphs' visibilities.",
